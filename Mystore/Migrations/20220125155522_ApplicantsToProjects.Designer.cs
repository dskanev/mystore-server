...
namespace Mystore.Api.Migrations
{
    ...
    [Migration("20220125155522_ApplicantsToProjects")]
    partial class ApplicantsToProjects
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mystore.Api.Data.Models.Project.Comment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Mystore.Api.Data.Models.Project.Project", b =>
                {
                    b.HasOne("Mystore.Api.Data.Models.User", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("Mystore.Api.Data.Models.User", b =>
                {
                    ...
                    b.HasOne("Mystore.Api.Data.Models.Project.Project", null)
                        .WithMany("Applicants")
                        .HasForeignKey("ProjectId");
                });
